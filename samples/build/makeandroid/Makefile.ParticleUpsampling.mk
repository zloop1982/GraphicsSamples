...
ParticleUpsampling_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ParticleUpsampling_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
ParticleUpsampling_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
ParticleUpsampling_debug_common_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
ParticleUpsampling_debug_common_cflags  += -funwind-tables -O0 -g -ggdb -fno-omit-frame-pointer -Wno-attributes
...
ParticleUpsampling_debug_cppflags  += -std="gnu++11"
...
antbuild_ParticleUpsampling_debug: preantbuild_ParticleUpsampling_debug
	dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) -f ./../../es2-aurora/ParticleUpsampling/build.xml debug
...
$(ParticleUpsampling_debug_bin): $(ParticleUpsampling_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug build_NvEGLUtil_debug 
	mkdir -p `dirname ./../../es2-aurora/ParticleUpsampling/libs/armeabi-v7a/libParticleUpsampling.so`
	$(CXX) -shared $(filter %.o, $(ParticleUpsampling_debug_obj)) $(ParticleUpsampling_debug_lflags) -lc -o $@ 
...
ParticleUpsampling_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ParticleUpsampling_release_lpaths    += ./../../../extensions/lib/Tegra-Android
ParticleUpsampling_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
ParticleUpsampling_release_common_cflags  += -fpic -fPIC -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstrict-aliasing -funswitch-loops -finline-limit=300
ParticleUpsampling_release_common_cflags  += -funwind-tables -O2 -fno-omit-frame-pointer -Wno-attributes
...
ParticleUpsampling_release_cppflags  += -std="gnu++11"
...
$(ParticleUpsampling_release_bin): $(ParticleUpsampling_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release build_NvEGLUtil_release 
	mkdir -p `dirname ./../../es2-aurora/ParticleUpsampling/libs/armeabi-v7a/libParticleUpsampling.so`
	$(CXX) -shared $(filter %.o, $(ParticleUpsampling_release_obj)) $(ParticleUpsampling_release_lflags) -lc -o $@ 
	$(ECHO) building $@ complete!
