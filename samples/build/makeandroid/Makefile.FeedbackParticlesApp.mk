...
FeedbackParticlesApp_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
FeedbackParticlesApp_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
FeedbackParticlesApp_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
FeedbackParticlesApp_debug_common_cflags  += -funwind-tables -O0 -g -ggdb -fno-omit-frame-pointer -Wno-attributes
...
FeedbackParticlesApp_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
FeedbackParticlesApp_release_lpaths    += ./../../../extensions/lib/Tegra-Android
FeedbackParticlesApp_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
FeedbackParticlesApp_release_common_cflags  += -funwind-tables -O2 -fno-omit-frame-pointer -Wno-attributes
