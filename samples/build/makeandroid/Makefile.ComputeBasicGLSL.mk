...
ComputeBasicGLSL_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/platforms/android-19/arch-arm/usr/include
...
ComputeBasicGLSL_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ComputeBasicGLSL_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
ComputeBasicGLSL_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
ComputeBasicGLSL_debug_lflags  += --sysroot=$(NDKROOT)/platforms/android-19/arch-arm -shared -Wl,--no-undefined
...
antbuild_ComputeBasicGLSL_debug: preantbuild_ComputeBasicGLSL_debug
	dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) -f ./../../es3aep-kepler/ComputeBasicGLSL/build.xml debug
...
$(ComputeBasicGLSL_debug_bin): $(ComputeBasicGLSL_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug build_NvEGLUtil_debug 
	mkdir -p `dirname ./../../es3aep-kepler/ComputeBasicGLSL/libs/armeabi-v7a/libComputeBasicGLSL.so`
	$(CXX) -shared $(filter %.o, $(ComputeBasicGLSL_debug_obj)) $(ComputeBasicGLSL_debug_lflags) -lc -o $@ 
...
ComputeBasicGLSL_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/platforms/android-19/arch-arm/usr/include
...
ComputeBasicGLSL_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ComputeBasicGLSL_release_lpaths    += ./../../../extensions/lib/Tegra-Android
ComputeBasicGLSL_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
ComputeBasicGLSL_release_lflags  += --sysroot=$(NDKROOT)/platforms/android-19/arch-arm -shared -Wl,--no-undefined
...
$(ComputeBasicGLSL_release_bin): $(ComputeBasicGLSL_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release build_NvEGLUtil_release 
	mkdir -p `dirname ./../../es3aep-kepler/ComputeBasicGLSL/libs/armeabi-v7a/libComputeBasicGLSL.so`
	$(CXX) -shared $(filter %.o, $(ComputeBasicGLSL_release_obj)) $(ComputeBasicGLSL_release_lflags) -lc -o $@ 
	$(ECHO) building $@ complete!
