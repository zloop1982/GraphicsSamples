...
ComputeWaterSimulation_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ComputeWaterSimulation_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
ComputeWaterSimulation_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
antbuild_ComputeWaterSimulation_debug: preantbuild_ComputeWaterSimulation_debug
	dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) -f ./../../es3aep-kepler/ComputeWaterSimulation/build.xml debug
...
$(ComputeWaterSimulation_debug_bin): $(ComputeWaterSimulation_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug build_NvEGLUtil_debug 
	mkdir -p `dirname ./../../es3aep-kepler/ComputeWaterSimulation/libs/armeabi-v7a/libComputeWaterSimulation.so`
	$(CXX) -shared $(filter %.o, $(ComputeWaterSimulation_debug_obj)) $(ComputeWaterSimulation_debug_lflags) -lc -o $@ 
...
ComputeWaterSimulation_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ComputeWaterSimulation_release_lpaths    += ./../../../extensions/lib/Tegra-Android
ComputeWaterSimulation_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
$(ComputeWaterSimulation_release_bin): $(ComputeWaterSimulation_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release build_NvEGLUtil_release 
	mkdir -p `dirname ./../../es3aep-kepler/ComputeWaterSimulation/libs/armeabi-v7a/libComputeWaterSimulation.so`
	$(CXX) -shared $(filter %.o, $(ComputeWaterSimulation_release_obj)) $(ComputeWaterSimulation_release_lflags) -lc -o $@ 
	$(ECHO) building $@ complete!
