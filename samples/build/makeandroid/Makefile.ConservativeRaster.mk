...
ConservativeRaster_debug_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/platforms/android-19/arch-arm/usr/include
...
ConservativeRaster_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ConservativeRaster_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
ConservativeRaster_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
ConservativeRaster_debug_lflags  += --sysroot=$(NDKROOT)/platforms/android-19/arch-arm -shared -Wl,--no-undefined
...
antbuild_ConservativeRaster_debug: preantbuild_ConservativeRaster_debug
	dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) -f ./../../gl4-maxwell/ConservativeRaster/build.xml debug
...
$(ConservativeRaster_debug_bin): $(ConservativeRaster_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug build_NvEGLUtil_debug 
	mkdir -p `dirname ./../../gl4-maxwell/ConservativeRaster/libs/armeabi-v7a/libConservativeRaster.so`
	$(CXX) -shared $(filter %.o, $(ConservativeRaster_debug_obj)) $(ConservativeRaster_debug_lflags) -lc -o $@ 
...
ConservativeRaster_release_hpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/platforms/android-19/arch-arm/usr/include
...
ConservativeRaster_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
ConservativeRaster_release_lpaths    += ./../../../extensions/lib/Tegra-Android
ConservativeRaster_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
ConservativeRaster_release_lflags  += --sysroot=$(NDKROOT)/platforms/android-19/arch-arm -shared -Wl,--no-undefined
...
$(ConservativeRaster_release_bin): $(ConservativeRaster_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release build_NvEGLUtil_release 
	mkdir -p `dirname ./../../gl4-maxwell/ConservativeRaster/libs/armeabi-v7a/libConservativeRaster.so`
	$(CXX) -shared $(filter %.o, $(ConservativeRaster_release_obj)) $(ConservativeRaster_release_lflags) -lc -o $@ 
	$(ECHO) building $@ complete!
