...
BindlessApp_debug_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
BindlessApp_debug_lpaths    += ./../../../extensions/lib/Tegra-Android
BindlessApp_debug_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
antbuild_BindlessApp_debug: preantbuild_BindlessApp_debug
	dos2unix $(ANT_TOOL); JAVA_HOME=$(JAVA_HOME) $(ANT_TOOL) -f ./../../gl4-kepler/BindlessApp/build.xml debug
mainbuild_BindlessApp_debug: prebuild_BindlessApp_debug $(BindlessApp_debug_bin)
prebuild_BindlessApp_debug:

$(BindlessApp_debug_bin): $(BindlessApp_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug build_NvEGLUtil_debug 
	mkdir -p `dirname ./../../gl4-kepler/BindlessApp/libs/armeabi-v7a/libBindlessApp.so`
	$(CXX) -shared $(filter %.o, $(BindlessApp_debug_obj)) $(BindlessApp_debug_lflags) -lc -o $@ 
...
BindlessApp_release_lpaths    += $(if $(NVPACK_ROOT),$(NVPACK_ROOT),$(error the environment must define NVPACK_ROOT))/$(if $(NVPACK_NDK_VERSION),$(NVPACK_NDK_VERSION),android-ndk-r9d)/sources/cxx-stl/gnu-libstdc++/$(if $(NVPACK_NDK_TOOL_VERSION),$(NVPACK_NDK_TOOL_VERSION),4.8)/libs/armeabi-v7a
BindlessApp_release_lpaths    += ./../../../extensions/lib/Tegra-Android
BindlessApp_release_lpaths    += ./../../../extensions/externals/lib/Tegra-Android
...
$(BindlessApp_release_bin): $(BindlessApp_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release build_NvEGLUtil_release 
	mkdir -p `dirname ./../../gl4-kepler/BindlessApp/libs/armeabi-v7a/libBindlessApp.so`
	$(CXX) -shared $(filter %.o, $(BindlessApp_release_obj)) $(BindlessApp_release_lflags) -lc -o $@ 
	$(ECHO) building $@ complete!
